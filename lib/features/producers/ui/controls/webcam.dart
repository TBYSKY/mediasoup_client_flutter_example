...
class Webcam extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final int videoInputDevicesLength = context
        .select((MediaDevicesBloc bloc) => bloc.state.videoInputs.length);
    final bool inProgress =
        context.select((MeBloc bloc) => bloc.state.webcamInProgress);
    final Producer? webcam =
        context.select((ProducersBloc bloc) => bloc.state.webcam);
